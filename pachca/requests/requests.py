...
def send_post_request(url, headers="", data=None, json:Json={}, files=None) -> Json:
...
def send_delete_request(url, headers, json:Json={}) -> Json:
...
def send_put_request(url, headers="", data=None, json:Json={}, files=None) -> Json:
